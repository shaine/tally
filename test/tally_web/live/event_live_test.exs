defmodule TallyWeb.EventLiveTest do
  use TallyWeb.ConnCase

  import Phoenix.LiveViewTest
  import Tally.TrackerFixtures

  @create_attrs %{name: "some name", occurred_at: "2024-10-18T02:26:00"}
  @update_attrs %{name: "some updated name", occurred_at: "2024-10-19T02:26:00"}
